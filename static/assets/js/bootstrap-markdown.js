!function(t) {
    ...
    var e = function(e, n) {
        ...
        t.each(i, function(i, a) {
            "undefined" != typeof t(e).data(a) && (n = "object" == typeof n ? n : {},
                n[a] = t(e).data(a))
        }),
    ...
    e.prototype = {
        ...
        __alterButtons: function(e, n) {
            ...
            t.each(i, function(t, i) {
                var s = !0;
                s = !a && i.indexOf(e) < 0,
                s === !1 && n(o.$editor.find('button[data-handler="' + i + '"]'))
            })
        },
            ...
            for (i = 0; i < e.length; i++) {
                ...
                for (r = 0; r < l.length; r++) {
                    ...
                    for (c = 0; c < h.length; c++) {
                        var u, f, p = h[c], g = a + "-" + p.name, v = this.__getIcon(p.icon), m = p.btnText ? p.btnText : "", b = p.btnClass ? p.btnClass : "btn", y = p.tabIndex ? p.tabIndex : "-1", x = "undefined" != typeof p.hotkey ? p.hotkey : "", $ = "undefined" != typeof jQuery.hotkeys && "" !== x ? " (" + x + ")" : "";
                        u = t("<button></button>"),
                            u.text(" " + this.__localize(m)).addClass("btn-default btn-sm").addClass(b),
                        b.match(/btn\-(primary|success|info|warning|danger|link)/) && u.removeClass("btn-default"),
                            u.attr({
                                type: "button",
                                title: this.__localize(p.title) + $,
                                tabindex: y,
                                "data-provider": a,
                                "data-handler": g,
                                "data-hotkey": x
                            }),
                        p.toggle === !0 && u.attr("data-toggle", "button"),
                            f = t("<span/>"),
                            f.addClass(v),
                            f.prependTo(u),
                            d.append(u),
        ...
        setFullscreen: function(e) {
            var n = this.$editor
                , i = this.$textarea;
            e === !0 ? (n.addClass("md-fullscreen-mode"),
        ...
        showEditor: function() {
            ...
            if (null === this.$editor) {
                ...
                if (l.savable) {
                    ...
                    s.push(m),
                        r.push(l.onSave),
                        p.append('<button class="btn btn-success" data-provider="' + i + '" data-handler="' + m + '"><i class="icon icon-white icon-ok"></i> ' + this.__localize("Save") + "</button>")
                }
                if (v = "function" == typeof l.footer ? l.footer(this) : l.footer,
                "" !== t.trim(v) && (g = !0,
                    p.append(v)),
                g && c.append(p),
                ...
                l.height && "inherit" !== l.height)
                    if (jQuery.isNumeric(l.height)) {
                        var b = l.height;
                        h && (b = Math.max(0, b - h.outerHeight())),
                        p && (b = Math.max(0, b - p.outerHeight())),
                            e.css("height", b + "px")
                    } else
                        c.addClass(l.height);
                this.$editor = c,
            ...
            l.fullscreen.enable && l.fullscreen !== !1 && (this.$editor.append('<div class="md-fullscreen-controls"><a href="#" class="exit-fullscreen" title="Exit fullscreen"><span class="' + this.__getIcon(l.fullscreen.icons.fullscreenOff) + '"></span></a></div>'),
            ...
            l.dropZoneOptions && (this.$editor.dropzone ? (l.dropZoneOptions.init = function() {
                var t = 0;
                ...
                this.$editor.dropzone(l.dropZoneOptions)) : console.log("dropZoneOptions was configured, but DropZone was not detected.")),
                l.onShow(this),
                this
        },
