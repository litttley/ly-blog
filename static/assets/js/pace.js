(function() {
        var t, e, n, r, s, o, i, u, a, c, l, p, h, f, d, g, m, y, v, w, b, k, S, q, L, x, P, T, R, j, E, O, M, A, N, _, F, C, U, W, X, D, H, I, z, G, B, J, K, Q = [].slice, V = {}.hasOwnProperty, Y = function(t, e) {
                function n() {
                    this.constructor = t
                }
                for (var r in e)
             ...
             null == E && (E = function(t) {
                 ...
                 k = function() {
                     ...
                     for (e = arguments[0],
                         ...
                         if (n = r[o])
                             for (t in n)
                                 V.call(n, t) && (s = n[t],
                                     null != e[t] && "object" == typeof e[t] && null != s && "object" == typeof s ? k(e[t], s) : e[t] = s);
                     return e
                 }
                 ,
                 m = function(t) {
                 ...
                 q = function(t, e) {
                     ...
                     null == e && (e = !0),
                         ...
                         if (n = s.getAttribute("data-pace-" + t),
                             !e)
                             return n;
                         try {
                             return JSON.parse(n)
                 ...
                 window.Pace = c,
                 k(c, i.prototype),
                 j = c.options = k({}, b, window.paceOptions, q()),
        ...
        a = function(t) {
            ...
            _ = function(t) {
                ...
                "track" === P[0])
                    return "force";
                if (!P.length && j.ajax) {
                    if ("socket" === t && j.ajax.trackWebSockets)
                        return !0;
                    if (e = t.toUpperCase(),
                    Z.call(j.ajax.trackMethods, e) >= 0)
                        return !0
                }
                return !1
            }
                ...
                function e() {
                    ...
                    if (null != W && j.ajax.trackWebSockets) {
                        window.WebSocket = function(t, e) {
                            var r;
                            return r = null != e ? new W(t,e) : new W(t),
                            _("socket") && n.trigger("request", {
                                type: "socket",
                                url: t,
                                protocols: e,
                                request: r
            ...
            I = null,
            L = function() {
                return null == I && (I = new l),
                    I
            }
            ,
            N = function(t) {
                var e, n, r, s;
                for (s = j.ajax.ignoreURLs,
                         n = 0,
                         r = s.length; n < r; n++)
                    if (e = s[n],
                    "string" == typeof e) {
            ...
            L().on("request", function(e) {
                ...
                if (o = e.type,
                    ...
                    i = e.url,
                    !N(i))
                    return c.running || j.restartOnRequestAfter === !1 && "force" !== _(o) ? void 0 : (r = arguments,
                        n = j.restartOnRequestAfter || 0,
                    "boolean" == typeof n && (n = 0),
                        setTimeout(function() {
                            var e, n, i, u, a, l;
                            if (e = "socket" === o ? s.readyState < 2 : 0 < (u = s.readyState) && u < 4) {
                                for (c.restart(),
                                         a = c.sources,
                                         l = [],
                                         n = 0,
            ...
            t = function() {
                ...
                return t.prototype.watch = function(t) {
                    ...
                    if (r = t.type,
                        ...
                        s = t.url,
                        !N(s))
                        return n = "socket" === r ? new f(e) : new d(e),
            ...
            d = function() {
                function t(t) {
                    var e, n, r, s, o, i, u = this;
                    if (this.progress = 0,
                    null != window.ProgressEvent)
                        for (n = null,
                                 t.addEventListener("progress", function(t) {
                                     return t.lengthComputable ? u.progress = 100 * t.loaded / t.total : u.progress = u.progress + (100 - u.progress) / 2
                                 }, !1),
                        ...
                        o = t.onreadystatechange,
                            t.onreadystatechange = function() {
                                var e;
                                return 0 === (e = t.readyState) || 4 === e ? u.progress = 100 : 3 === t.readyState && (u.progress = 50),
                    ...
                    this.progress = 0,
                        ...
                        e = setInterval(function() {
                            ...
                            s.length > j.eventLag.sampleCount && s.shift(),
                                t = m(s),
                                ++r >= j.eventLag.minSamples && t < j.eventLag.lagThreshold ? (o.progress = 100,
            ...
            h = function() {
                ...
                return t.prototype.tick = function(t, e) {
                    var n;
                    return null == e && (e = O(this.source, "progress")),
                    e >= 100 && (this.done = !0),
            ...
            ,
        null != window.history.pushState && (G = window.history.pushState,
                window.history.pushState = function() {
                    return x(),
                        G.apply(window.history, arguments)
                }
        ),
        null != window.history.replaceState && (K = window.history.replaceState,
            ...
            (T = function() {
                    ...
                    for (c.sources = C = [],
                             ...
                             s = i.length; n < s; n++)
                        t = i[n],
                        j[t] !== !1 && C.push(new p[t](j[t]));
                    for (a = null != (u = j.extraSources) ? u : [],
                             r = 0,
                             o = a.length; r < o; r++)
                        F = a[r],
                            C.push(new F(j));
                    return c.bar = y = new e,
                        A = [],
                        U = new h
                }
            )(),
            ...
            c.go = function() {
                ...
                return c.running = !0,
                    ...
                    v = !1,
                    g = M(function(e, n) {
                        var r, s, o, i, u, a, l, p, f, d, g, m, w, b, k, S;
                        for (p = 100 - y.progress,
                                 s = g = 0,
                                 o = !0,
                                 a = m = 0,
                                 b = C.length; m < b; a = ++m)
